...
# ╔═╡ 98bd16fe-3e9f-474b-afdc-ccf4e77a5965
begin
	using CitableBase
...
# ╔═╡ a7ac0e4e-85de-11ec-2522-ed9dbc851915
md"""
# HMT project authority list validator

> ### How to validate an authority list
>
...
# ╔═╡ a5624206-8d65-431e-878c-b95a3bbed65b
md"""
## Validate an authority list
"""
...
# CEX catalog of all authority lists
begin
	reload
	catalogcex = read(joinpath(pwd(), "catalog", "catalog-data.cex"), String)
	citedworkscex =  read(joinpath(pwd(), "data", "citedworks.cex"), String)
	placenamescex = read(joinpath(pwd(), "data", "hmtplaces.cex"), String)
	personnamescex = read(joinpath(pwd(), "data", "hmtnames.cex"), String)
...
git-tree-sha1 = "fb591c8896bd4d2034d30b1bacdc0c5083ca4116"
